...
<html>
	...
	<body>
		...
		<div class="bs-callout bs-callout-info">
		    <h4>结合一般查询条件表格</h4>
		    <p>
		    	包含功能：分页，排序，多选，cardView切换，列选择，普通数据检索
		    </p>
		  </div>
	...
	$('#search_go').click(function(){
		...
		<form class="form-horizontal sl_all_form">
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control" id="xh" name="xh"
									maxlength="20"/>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control" id="xm" name="xm"
									maxlength="20"/>
							</div>
						</div>
					</div>
			...
			<div class="row sl_aff_btn" id="searchResult">
				<div class="col-sm-12">
					<button type="button" class="btn btn-primary btn-sm" id="search_go" return false;">
						查 询
					</button>
				</div>
			</div>
