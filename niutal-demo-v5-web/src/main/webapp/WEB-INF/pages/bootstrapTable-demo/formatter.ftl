...
$(function(){
	var options = {
	 ...
	 columns: [	//列定义
	    	...
	    	{field: 'xbmc',title: '性别',sortable:true,formatter:function(val){
			            	if(val == '男性')
			            		return  '<i class="fa fa-mars-stroke"></i>';
			            	else if(val == '女性')
			            		return  '<i class="fa fa-mars-stroke-h"></i>';
			            	else
			...
			$(function(){
				var ops = {
					 ...
					 columns: [
			            ...
			            {field: 'xbmc',title: '性别',sortable:true,formatter:function(val){
			            	if(val == '男性')
			            		return  '<i style="color:red" class="fa fa-mars-stroke"></i>';
			            	else if(val == '女性')
			            		return  '<i style="color:green" class="fa fa-mars-stroke-h"></i>';
			            	else
			            		return  '<i class="fa fa-genderless"></i>';
			            } }, 
			            {field: 'bmmc',title: '学院',sortable:true},
