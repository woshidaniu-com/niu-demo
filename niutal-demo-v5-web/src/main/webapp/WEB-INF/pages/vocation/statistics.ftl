...
<html>
	...
	<body>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control input-sm span3 chosen-select" name="auditStatus" id="cx_auditStatus">
									<option value="">全部 </option>
								...
								<SCRIPT type="text/javascript">
						    		jQuery('#cx_auditStatus').trigger("chosen");
			 			    	</SCRIPT>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="${base}/js/vocation/statistics.js?ver=${messageUtil("niutal.jsVersion")}"></script>
	</body>
</html>
